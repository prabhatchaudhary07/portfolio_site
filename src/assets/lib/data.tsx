...
export const headerIntroData = {
  title: {
    de: "नमस्ते, मैं प्रभात हूं",
    en: "Hi, I'm Prabhat",
  },
  subtitle: "Backend Developer",
  description: {
    de: "मैं प्रभात, एक बैकएंड डेवलपर हूं जिसका लक्ष्य अपने करियर को आगे बढ़ाना और प्रेरक परियोजनाओं में भाग लेना है। यहां मैं अपना काम और वेब विकास के प्रति अपना जुनून प्रस्तुत करता हूं। आइए मिलकर डिजिटल समाधानों को आकार दें और भविष्य को आकार दें!",
    en: "I'm Prabhat, a backend developer with the goal of advancing my career and participating in inspiring projects. Here I present my work and my passion for web development. Let's shape digital solutions together and shape the future!",
  },
  buttons: [
    {
      name: "Contact",
      label: {
        de: "मुझसे संपर्क करें",
        en: "Contact me",
      },
      icon: FiMail,
      color: "main-btn",
...
export const sideBarRightMail = {
  link: "mailto:realinfox12@gmail.com",
  text: "realinfox12@gmail.com",
} as const;

export const sideBarLeftSocials = [
  {
    link: "https://www.linkedin.com/in/prabhat-chaudhary/",
    icon: FiLinkedin,
    altimgname: "linkedin",
  },
  {
    link: "https://github.com/prabhatchaudhary07",
    icon: FiGithub,
    altimgname: "github",
  },
  {
